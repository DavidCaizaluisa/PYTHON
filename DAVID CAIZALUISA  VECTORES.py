# -*- coding: utf-8 -*-
"""
Created on Tue Jul 21 09:15:09 2020
...
while preguntar:
    print("\nSi desea terminar  digite <<0>> caso contrario puede")
    print("Ingresar el tamaño del vector,  deber ser mayor que 3 y",
          "menor que 30: ")  
    tamaño=int(input())
    if tamaño>=3 and tamaño<=30:
        while preguntar:  
            print("\n[Si desea cambiar el tamaño del vector ingrese <<0>> caso contrario elija las otras opciones]")
